...
\begin{overprint}
\begin{figure}
 \includegraphics<1->[scale=0.2, angle=270]{ecomap_abfall2.pdf}
 \caption{Ecomap -- Abfall}
\end{figure}
...
\section{Ergebnisse}
\subsection{Abfall}
\frame{\frametitle{Ergebnisse im Bereich Abfall\hfill{}\footnotesize HSLU -- T\&A}
...
\subsection{Energie}
\frame{\frametitle{Ergebnisse im Bereich Energie\hfill{}\footnotesize HSLU -- T\&A}
\begin{block}{Aktuelle Lage}
\begin{itemize}
...
\frame{\frametitle{Ergebnisse im Bereich Sicherheit\hfill{}\footnotesize HSLU -- T\&A}
...
\begin{overprint}
\begin{figure}
\includegraphics<1>[scale=0.22, angle=0]{fluchtplan3.pdf}
\caption{Fluchtplan}
\end{figure}
\end{overprint}
\end{column}
